...
AUTH_LDAP_REQUIRE_GROUP = "cn=allsaintsdjango,ou=groups,dc=yeomans,dc=io"
AUTH_LDAP_USER_ATTR_MAP = {"first_name": "givenName", "last_name": "sn"}
AUTH_LDAP_USER_FLAGS_BY_GROUP = {
    "is_staff": "cn=allsaintsdjango,ou=groups,dc=yeomans,dc=io",
    "is_superuser": "cn=allsaintsdjangosuper,ou=groups,dc=yeomans,dc=io"
}
